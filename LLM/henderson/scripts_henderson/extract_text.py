...
PDF_PATH   = Path("LLM/henderson/pdf_henderson/invasive_alien_plants_in_south_africa.pdf")
OUT_RAW_DIR = Path("LLM/henderson/extracted_text_henderson/pages")
OUT_RAW_DIR.mkdir(parents=True, exist_ok=True)
OUT_DEBUG  = Path("LLM/henderson/extracted_text_henderson/all_text_debug.txt")
