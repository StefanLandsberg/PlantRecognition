...
# Add the parent directory of TeamC (which contains both TeamC and descriptormodel)
# to the Python path.
# This assumes 'descriptormodel' is a sibling directory to 'TeamC'.
current_dir = os.path.dirname(os.path.abspath(__file__))
# Go up one level to the common parent folder (PlantRecognition-main)
parent_dir = os.path.dirname(current_dir)
sys.path.append(parent_dir)

# Now, your imports should be:
from descriptormodel.hyper_detailed_pattern_recognition import MultiModalCurseResistantRecognizer
from descriptormodel.training import DirectClassificationNetwork
